# CLAUDE.md - CelebrationSeason.net

## Project Identity

**Site:** https://celebrationseason.net/
**Codename:** CelebrationExpert
**Niche:** Party Planning & Celebrations
**Mode:** Light-first (Bright & Celebratory)
**Amazon Tag:** celebrationseason-20
...
App Password: uM1s 4n54 mmDQ WYVV 3dfQ hRw2
```
...
### Personality
- **Archetype:** Creator/Entertainer
- **Voice:** The natural host making every gathering feel special without stress
- **Tone:** Joyful, practical, accessible - great parties that feel effortless
- **NOT:** Pinterest-perfect pressure, expensive-only ideas, stressful

### Color Palette
| Token | Hex | Usage |
|-------|-----|-------|
| Primary | #DC143C | Celebration Crimson - CTAs, highlights |
| Secondary | #FFD700 | Festive Gold - accents, special |
| Accent | #228B22 | Holiday Green - seasonal |
| Background | #FFFEFA | Warm White |
| Surface | #FFF8F0 | Cream |
| Surface Elevated | #F5F0E8 | Light Warm |
...
### Systeme.io
```
Tag: celebrationseason-popup-partyplanner
Tag: celebrationseason-leadmagnet-checklist
```

### Amazon
```
Affiliate Tag: celebrationseason-20
```
...
**Title:** "Ultimate Party Planning Checklist Bundle"
**Format:** PDF + Printables
**Contents:** Timeline checklists for every type of celebration

---

## Content Categories
1. Birthday Parties - All ages
2. Holiday Celebrations - Seasonal
3. Weddings & Showers - Milestone events
4. Themed Parties - Creative concepts
5. Easy Entertaining - Simple gatherings
6. DIY Decor - Budget-friendly ideas

---

## Anti-Patterns

- ❌ Pinterest-perfect unrealistic expectations
- ❌ Only expensive/elaborate ideas
- ❌ Stressful "must-have" pressure
- ❌ Generic party stock photos
- ❌ Condescending tone
- ❌ Ignoring budget constraints

---

*Generated from Creative Command Center DNA: celebration-season.json*
...
1. **Load Memory Context**
   ```
   Search memory for: celebrationseason context state decisions
   ```
...
4. **Check Open Tasks**
   ```
   mcp_memory_get key="open_tasks" context="celebrationseason"
   ```
...
```markdown
## SESSION CONTEXT: Celebration Season
Site: https://celebrationseason.com
Amazon Tag: celebrationseason-20

## RULES FOR THIS SESSION
1. ALWAYS use warm celebration expert helping families create memorable moments voice - NEVER deviate
2. Include affiliate tag celebrationseason-20 on all product links
...
Ready to work on Celebration Season. What's the task?
```
...
mem0_add({
  ...
  text: "Decided to use glass morphism for cards on Celebration Season",
  metadata: { site: "celebrationseason", type: "decision" }
})
...
```
celebrationseason_state          - Current project state
celebrationseason_decisions      - Key decisions made
celebrationseason_tasks          - Task tracking
celebrationseason_preferences    - Discovered preferences
celebrationseason_solutions      - Technical solutions
celebrationseason_session_{date} - Session notes
```
...
```javascript
mcp_memory_set({
  key: "celebrationseason_session_" + new Date().toISOString().split('T')[0],
  value: JSON.stringify({
    completed: [...],
    pending: [...],
    decisions: [...],
...
<?php
/**
 * Plugin Name: MCP Tools - Celebration Season
 * Description: Custom MCP tools for https://celebrationseason.com
 * Version: 1.0.0
...
class MCP_Tools_CelebrationSeason {
...
add_action( 'plugins_loaded', function() {
    MCP_Tools_CelebrationSeason::get_instance();
}, 20 );
```
...
- - `cs_party_guide` - Generate party planning guides
- `cs_seasonal_content` - Create seasonal celebration content
- `cs_gift_guide` - Generate gift guides by occasion
...
### Site-Specific Rules: Celebration Season
1. Voice: Warm, festive, family-focused, helpful
2. Affiliate Tag: celebrationseason-20 on ALL Amazon links
3. Design: Warm festive colors, celebration-oriented, joyful
4. Content: Family-friendly, practical party planning, seasonal focus
5. Anti-patterns: Overly commercial, generic advice, exclusionary content
...
| Resource | URL |
|----------|-----|
| WordPress Admin | https://celebrationseason.com/wp-admin |
| MCP Endpoint | https://celebrationseason.com/wp-json/mcp/v1/bearer/sse |
| Site Frontend | https://celebrationseason.com |
